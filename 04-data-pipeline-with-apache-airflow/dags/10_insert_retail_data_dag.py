...
with DAG(
    ...
    order_task = PythonOperator(
        ...
        python_callable=create_and_load_orders
    )

    product_task = PythonOperator(
        task_id='create_products',
        python_callable=create_and_load_products
    )
    ...
    store_task = PythonOperator(
        ...
        python_callable=create_and_load_stores
    )

    inventory_task = PythonOperator(
        task_id='create_inventory',
        python_callable=create_and_load_inventory
    )

    promotion_task = PythonOperator(
        task_id='create_promotions',
        python_callable=create_and_load_promotions
    )

    # Set dependencies
    order_task >> product_task >> customer_task >> store_task >> inventory_task >> promotion_task
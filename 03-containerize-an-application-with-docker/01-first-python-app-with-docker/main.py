...
engine = create_engine('sqlite:////workspaces/data-ai-bootcamp/02-data-programming/mysqlite01.db')
fake = faker.Faker()
...
while True:
    ...
    print(f"Created {len(customers)} customers to SQLite at {time.strftime('%H:%M:%S')}")
    time.sleep(5)